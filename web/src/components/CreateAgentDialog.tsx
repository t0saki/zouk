...
export default function CreateAgentDialog({
  ...
  return (
    ...
    >
      <div className="bg-nb-white dark:bg-dark-surface border-3 border-nb-black dark:border-dark-border shadow-nb-lg w-full max-w-[520px] mx-4 max-h-[90vh] overflow-y-auto animate-bounce-in">
        {/* Header */}
